...
app.get("/scrape", function(req, res) {
  ...
  request("http://www.pcgamer.com/news/", function(error, response, html) {
    ...
    $("article.search-result.search-result-news.optional-image-wrapper.has-rating").each(function(i, element) {
      // div.listElmnt.promo-content
      // Save an empty result object
      var result = {};
      // Add the text and href of every link, and save them as properties of the result object
      // result.title = $(this).siblings().find("a.storylink").text();
      ...
      // result.image = $(this).find("a.listElmt-storyHeadline.wiki-thumb").children("img").attr("src");      
      // console.log(result);
